      ...
      <div className="max-w-3xl mx-auto space-y-6">
        ...
        <div className="space-y-5 text-sm text-slate-400 leading-relaxed">
          ...
          <section>
            ...
            <p>
              تُقدَّم بعض الميزات ضمن خطط اشتراك مدفوعة تُفوتَر شهرياً عبر YouCanPay. الاشتراك يُجدَّد يدوياً كل شهر
              ولا يلتزم العميل بأي مدة طويلة؛ يكفي عدم تجديد الدفعة القادمة للعودة تلقائياً للخطة المجانية. لا
              تُرَد المبالغ عن الفترة الجارية عند عدم التجديد ما لم يُذكَر خلاف ذلك.
            </p>
          </section>
          <section>
